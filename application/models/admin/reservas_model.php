...
class Reservas_model extends CI_Model
{
    ...
    function reservas_alojamiento($id_alojamiento)
    {
        $query = sprintf(
                "select 
                        ...
                        where pago_alojar='N' and alojamiento_id=%s", $id_alojamiento);
    ...
    function reservas_filtro($orden, $campo, $valor, $start, $end)
    {
        ...
        $query_select       = " select reserva_dat.reservas_id, reserva_dat.Localizador as localizador, Checkin, Checkout, NombreHuesped, ApellidoHuesped, Nombre, costo_total, estado_pago, metodo_pago, reserva_dat.fecha_reserva as fecha_reserva_dat ";
