...
class Reservas extends CI_Controller
{
    ...
    function buscar_disponibilidad_iii()
    {
        ...
        if ($mail_alojamiento)
        {
            ...
            $str_mail            = $this->parser->parse('admin/mails/mail_general', $data, true);
            $this->email->clear();
            $this->email->to('gudu.chango@gmail.com');
            $this->email->from('contacto@sanrafaellate.com.ar', 'SAN RAFAEL LATE (copia alojamiento)');
        ...
        if ($mail_huesped)
        {
            ...
            $this->email->clear();
            $this->email->to('gudu.chango@gmail.com');
            $this->email->from('contacto@sanrafaellate.com.ar', 'SAN RAFAEL LATE (copia huesped)');
            $this->email->subject('voucher');
            $this->email->message($str_mail);
            $this->email->send();
        }
        ...
        $this->email->clear();
        $this->email->to('gudu.chango@gmail.com');
        $this->email->from('contacto@sanrafaellate.com.ar', 'SAN RAFAEL LATE (copia sanrafaellate.com)');
        $this->email->subject('voucher');
        $this->email->message($str_mail);
        $this->email->send();
