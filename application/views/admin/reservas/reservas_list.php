    ...
    <table class="table">
        ...
        <?php foreach ($reservas_array as $var): ?>
            <tr class="success" >
                ...
                <td><a href=""></a><?php echo $var['Checkin']." , ".$var['Checkout'] ?></td>
                <td><?php echo $var['NombreHuesped'].", ".$var['ApellidoHuesped'] ?></td>
                <td><?php echo $var['Nombre'] ?></td>
                <td><?php echo $var['costo_total'] ?></td>
                <td><?php echo $var['estado_pago'] ?></td>
                <td><?php echo $var['fecha_reserva_dat'] ?></td>
                <td><?php echo $var['metodo_pago'] ?></td>
                <td><a href="<?php echo base_url()."admin/reservas/edit/".$var['reservas_id'] ?>"><i class="icon-edit"></i></a></td>
            </tr>
        <?php endforeach; ?>
    </table>
