            ...
            <table class="table">
                ...
                <?php foreach ($alojamientos_array as $var): ?>
                    <tr class="success" >
                        ...
                        <td>
                            <a href="<?php echo base_url() . "admin/alojamientos/form/" . $var['ID_Alojamiento'] ?>">
                                <i class="icon-edit"></i>
                            </a>&nbsp;&nbsp;
                            <a href="<?php echo base_url() . "admin/alojamientos/form_view/" . $var['ID_Alojamiento'] ?>/?pestania=info">
                                <i class="icon-align-justify"></i>
                            </a>&nbsp;&nbsp;
                            <?php if ($this->gf->pago_alojar($var['ID_Alojamiento'])): ?>
                                <a  href="<?php echo base_url() . "admin/pagoalojar/reservas_alojamientos/" . $var['ID_Alojamiento'] ?>">
                                    <i class="icon-shopping-cart"></i>
                                </a>&nbsp;&nbsp;
                            <?php endif ?>
                            <a  href="<?php echo base_url() . "admin/reservas/liquidacion/" . $var['ID_Alojamiento'] ?>">
                                <i class="icon-tags"></i>
                            </a>
