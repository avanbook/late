...
//SI NO ES PUBLI BASICA =0
  ...
  <div class="items" align="center">
    ...
    <img src="<?php echo base_url() . "upload/empresas/thumb/" . $var['ID_Empresa'] . "_1_p.jpg"; ?>" alt="<?php echo ucwords($var['Empresa']); ?> <?php echo $this->config->item('ciudadweb');; ?>" class="princ">
    <div class="dir_H" align="center">
      <h3><?php echo ucwords($var['Empresa']); ?></h3>
      <p><?php echo substr(strip_tags($var['Descripcion']),0,100) ?></p>
<!-- EMAIL-->
<?php if (isset($var['Mail'])){ ?>
<a href="#" title="<?php echo ucwords($var['Empresa']); ?>- " class="tooltip"> <img src="<?php echo base_url();?>iconos/email_F.png" alt="enviar Email " > <span><b>Haga click </b>en Icono para enviar email a este alojamiento</span>
</a>
<?php } ?>
<!-- direccion-->
...
<?php } ?>
<br><br>
<span class="butons"><a href="<?php echo base_url()."servicios/". $TipoEmpresa['TipoEmpresa']."/".$dirsubt."/". $var['Url'] ?>" title="<?php echo ucwords($var['Empresa']); ?>- <?php echo $this->config->item('ciudadweb');; ?> - Ver Ficha Informacion">Ver Ficha</a></span>
    </div>
  </div>
 <?php } 
  // PUBLICIDAD BASICA =1
...
<a href="#" title="<?php echo ucwords($var['Empresa']); ?>- <?php echo $this->config->item('ciudadweb');; ?> - Ver Ficha Informacion" class="tooltip xleft"> <img src="<?php echo base_url();?>iconos/email_F2.png" alt="" > <span><b>Haga click </b>en Icono para enviar email a este alojamiento</span>
</a>
<?php } ?>
<!-- direccion-->
<?php if (isset($var['Direccion'])){ ?>
