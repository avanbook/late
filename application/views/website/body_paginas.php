<div id="contenedor2">
 ...
 <div id="cont_full" align="left">
   <!-- BEGUIN CONT FULL-->
       <div id="toplinks" align="left"><b>Estas en: </b><a href="http://sanrafaellate.com" title="Ir a home">Home</a> >> <a href="<?php echo base_url() .$row_P['TipoPagina']."/". $row_P['UrlPagina'];?>" title="<?php echo $row_P['TipoPagina']; ?> en <?php echo $this->config->item('ciudadweb'); ?>"><?php echo $row_P['TipoPagina']; ?> </a> >> <?php echo $row_P['MetaTitulo']; ?> en <?php echo $this->config->item('ciudadweb');?></div>
...
<h2>Mas de <?php echo $nametop ;?></h2>
  	<?php foreach ($int_P as $var ) { ?>
		<div class="relactionItem">
			<div><img src="<?php echo base_url() . "upload/paginas/thumb/" . $var['ID_Pagina'] . "_".$var['ImagenPagina'].".jpg" ?>" alt="<?php echo $var['TituloContenido']; ?> en <?php echo $this->config->item('ciudadweb');; ?>"></div>
...
<h2>Mas Info de <?php echo $row_P['TituloPagina']; ?> </h2>
    ...
    <div class="relactionItem">
      <div><img src="<?php echo base_url() . "upload/paginas/thumb/" . $var['ID_Pagina'] . "_1.jpg" ?>" alt="<?php echo $var['TituloContenido']; ?> en <?php echo $this->config->item('ciudadweb');; ?>"></div>
      <div class="intt"><h3><a href="<?php echo base_url() . $var['TipoPagina']."/". $var['Url'] ?>" title="Ver Mas de <?php echo $var['TituloContenido']; ?>"><?php echo $var['TituloContenido']; ?></a></h3><p><?php echo substr(strip_tags($var['Contenido']),0, 70); ?></p></div>
